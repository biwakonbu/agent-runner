...
<style>
  ...
  .status-running {
    ...
    box-shadow: var(--mv-shadow-badge-glow-md) var(--mv-color-status-running-glow);
  ...
  .status-succeeded {
    ...
    box-shadow: var(--mv-shadow-badge-glow-sm) var(--mv-color-status-succeeded-border);
  }

  .status-completed {
    background: var(--mv-color-status-completed-bg);
    color: var(--mv-color-status-completed-text);
    border: var(--mv-border-width-thin) solid var(--mv-color-status-completed-border);
    box-shadow: var(--mv-shadow-badge-glow-lg) var(--mv-color-status-completed-glow);
  }
  ...
  .status-failed {
    ...
    box-shadow: var(--mv-shadow-badge-glow-sm) var(--mv-color-status-failed-border);
  }
